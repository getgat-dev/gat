---
title: "gat push"
description: "Upload tracked objects to remote storage."
---
...
```text
Usage: gat push [OPTIONS]
```

<Accordion title="All options" id="gat-push-options">
...
Options:
  -o, --full-output
      ...
      --remote <REMOTE>
          Remote to push to. Overrides path routing; when omitted, routes choose
          storage by path, with the configured default remote as fallback
...
```sh
gat push --path data/ --remote backup
```
