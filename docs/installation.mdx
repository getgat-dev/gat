...
<AccordionGroup>
  ...
  >
    ...
    Older releases may lack musl assets or require a newer glibc. If the chosen
    release has no asset for your target, the installer reports that and preserves
    your installation. Choose a release that provides it or build from source;
    the installer never silently substitutes another release or libc build.
  </Accordion>
