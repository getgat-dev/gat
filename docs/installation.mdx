...
<Steps>
  <Step title="Install gat">
    ...
    <Note>
      ...
      directory is not currently on your <Tooltip tip="The list of directories your shell searches when you type a command such as gat.">PATH</Tooltip>.
      If prompted, add it to `PATH` before continuing; opening a new shell alone
      does not add the directory.
    </Note>
  </Step>
