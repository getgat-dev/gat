...
<ResponseField name="cache.location" type="path">
  ...
  **Set with:** [`gat config cache.location <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="cache-location">
    - **Persisted default:** unset
    - **Environment override:** `GAT_CACHE_LOCATION`
...
<ResponseField name="cache.materialization_strategy" type="list">
  ...
  **Set with:** [`gat config cache.materialization_strategy <value>...`](/commands/config)
  ...
  <Accordion title="Configuration details" id="cache-materialization-strategy">
    ...
    - **Persisted default:** unset
    - **Environment override:** `GAT_CACHE_MATERIALIZATION_STRATEGY`
...
<ResponseField name="cache.ingest_strategy" type="enum">
  ...
  **Set with:** [`gat config cache.ingest_strategy <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="cache-ingest-strategy">
    - **Persisted default:** unset
    - **Environment override:** `GAT_CACHE_INGEST_STRATEGY`
    - **Example:** `safe`
  </Accordion>
</ResponseField>
...
<ResponseField name="sync.trust_state" type="boolean">
  ...
  **Set with:** [`gat config sync.trust_state <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="sync-trust-state">
    - **Values:** `true` | `false`
    - **Persisted default:** unset
    - **Environment override:** `GAT_SYNC_TRUST_STATE`
    - **Example:** `true`
  </Accordion>
</ResponseField>
...
<ResponseField name="sync.auto_fetch" type="boolean">
  ...
  **Set with:** [`gat config sync.auto_fetch <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="sync-auto-fetch">
    - **Values:** `true` | `false`
    - **Persisted default:** unset
    - **Environment override:** `GAT_SYNC_AUTO_FETCH`
    - **Example:** `true`
  </Accordion>
</ResponseField>
...
<ResponseField name="sync.auto_repair" type="boolean">
  ...
  **Set with:** [`gat config sync.auto_repair <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="sync-auto-repair">
    - **Values:** `true` | `false`
    - **Persisted default:** unset
    - **Environment override:** `GAT_SYNC_AUTO_REPAIR`
    - **Example:** `true`
  </Accordion>
</ResponseField>
...
`lock.shard_levels` is **Experimental**: its interface or behavior may change. See [Feature lifecycle](/references/feature-lifecycle).
  ...
  **Set with:** [`gat config lock.shard_levels <value>`](/commands/config)
  ...
  <Accordion title="Configuration details" id="lock-shard-levels">
    - **Range:** `0`-`2`
    - **Persisted default:** unset
    - **Environment override:** `GAT_LOCK_SHARD_LEVELS`
    - **Example:** `2`
  </Accordion>
</ResponseField>
...
<ResponseField name="git.ignore_patterns" type="list">
  ...
  **Set with:** [`gat config git.ignore_patterns <value>...`](/commands/config)
  ...
  <Accordion title="Configuration details" id="git-ignore-patterns">
    ...
    - Order is significant.
    - **Persisted default:** unset
    - **Environment override:** `GAT_GIT_IGNORE_PATTERNS`
...
<ResponseField name="network.readiness_timeout_seconds" type="integer">
  Total budget in seconds for establishing remote readiness.

  **Default:** `5`

  **Set with:** [`gat config network.readiness_timeout_seconds <value>`](/commands/config)

  <Accordion title="Configuration details" id="network-readiness-timeout-seconds">
    - **Range:** `1`-`86400`
    - **Persisted default:** unset
    - **Environment override:** `GAT_NETWORK_READINESS_TIMEOUT_SECONDS`
    - **Example:** `5`
  </Accordion>
</ResponseField>

<ResponseField name="network.operation_timeout_seconds" type="integer">
  Timeout in seconds for one backend operation attempt, not an entire transfer.

  **Default:** `30`

  **Set with:** [`gat config network.operation_timeout_seconds <value>`](/commands/config)

  <Accordion title="Configuration details" id="network-operation-timeout-seconds">
    - **Range:** `1`-`86400`
    - **Persisted default:** unset
    - **Environment override:** `GAT_NETWORK_OPERATION_TIMEOUT_SECONDS`
    - **Example:** `60`
  </Accordion>
</ResponseField>

<ResponseField name="network.io_timeout_seconds" type="integer">
  Timeout in seconds for one read, write, or body operation.

  **Default:** `60`

  **Set with:** [`gat config network.io_timeout_seconds <value>`](/commands/config)

  <Accordion title="Configuration details" id="network-io-timeout-seconds">
    - **Range:** `1`-`86400`
    - **Persisted default:** unset
    - **Environment override:** `GAT_NETWORK_IO_TIMEOUT_SECONDS`
    - **Example:** `60`
  </Accordion>
</ResponseField>

<ResponseField name="network.request_concurrency" type="integer">
  Maximum simultaneous physical network requests per operation; logical scheduling is derived internally.

  **Default:** `256`

  **Set with:** [`gat config network.request_concurrency <value>`](/commands/config)

  <Accordion title="Configuration details" id="network-request-concurrency">
    - **Range:** `1`-`65535`
    - **Persisted default:** unset
    - **Environment override:** `GAT_NETWORK_REQUEST_CONCURRENCY`
    - **Example:** `256`
  </Accordion>
</ResponseField>
